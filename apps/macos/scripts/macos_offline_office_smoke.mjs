...
expectIncludes(wordAdapter, "VisualTeX_EditNativeSelection selected.Range", "Word native VisualTeX formulas must support double-click editing through the shared handler");
