...
mod tests {
    ...
    fn cache_round_trips_metadata_atomically() {
        ...
        assert_eq!(loaded.font_size_pt, Some(12.0));
        assert_eq!(loaded.reference_width_pt, Some(60.0));
        assert_eq!(loaded.reference_height_pt, Some(15.0));
        assert_eq!(loaded.reference_baseline_pt, Some(-3.0));
        assert!(!temp
            .path()
