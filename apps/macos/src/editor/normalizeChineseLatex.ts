...
export const visualTexAutoEscapeShortcutGroups: readonly VisualTexAutoEscapeShortcutGroup[] = [
  { id: "greek", titleVi: "chữ cái Hy Lạp", titleEn: "Greek letters", shortcuts: GREEK_INLINE_SHORTCUTS },
  { id: "operators", titleVi: "Toán tử cơ bản", titleEn: "Basic operators", shortcuts: BASIC_OPERATOR_INLINE_SHORTCUTS },
  { id: "relations", titleVi: "Quan hệ và tập hợp", titleEn: "Relations and sets", shortcuts: RELATION_INLINE_SHORTCUTS },
  { id: "arrows", titleVi: "Mũi tên", titleEn: "Arrows", shortcuts: ARROW_INLINE_SHORTCUTS },
  { id: "accents", titleVi: "Dấu", titleEn: "Accents", shortcuts: ACCENT_INLINE_SHORTCUTS },
  { id: "commands", titleVi: "Các lệnh thông dụng", titleEn: "Common commands", shortcuts: COMMON_COMMAND_INLINE_SHORTCUTS },
];
