...
assert(installVstoSource.includes("installed and runtime-verified"));
assert(installVstoSource.includes("Companion runtime verification"));
assert(!installVstoSource.includes("chain-verified"));
assert(runtimeTestSource.includes('COMAddIns.Item($ProgId)'));
