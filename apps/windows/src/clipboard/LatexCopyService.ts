...
export const latexCodeFormats: readonly LatexCodeFormatDefinition[] = [
  {
    ...
    titleEn: "Raw LaTeX",
    hint: "\\frac{x}{y}",
    descriptionVi: "Một công thức trên mỗi dòng không có trình bao bọc",
    descriptionEn: "One formula per line without wrappers",
  },
  {
    id: "inline-dollar",
    group: "single",
    titleVi: "Toán nội tuyến · ký hiệu đô la",
    titleEn: "Inline math · dollar signs",
    hint: "$ ... $",
    descriptionVi: "Gói mọi công thức bằng $...$",
    descriptionEn: "Wrap every formula with $...$",
  },
  {
    id: "inline-text-double-dollar",
    group: "single",
    titleVi: "Công thức nội tuyến · văn bản ngoài toán",
    titleEn: "Inline formula · text outside math",
    hint: "text$$x^2$$text",
    descriptionVi:
      "Giữ văn bản cấp cao nhất bên ngoài toán học và bọc các đoạn công thức bằng $$...$$; Chữ viết bên trong tiếng Trung và các cấu trúc toán học khác vẫn còn trong \\text{}",
    descriptionEn:
  ...
  },
  {
    id: "inline-paren",
    group: "single",
    titleVi: "Toán nội tuyến · dấu ngoặc đơn",
  ...
  },
  {
    id: "display-dollar",
    group: "single",
    titleVi: "Hiển thị toán học · gấp đôi đô la",
  ...
  },
  {
    id: "display-bracket",
    group: "single",
    titleVi: "Hiển thị phép toán · dấu ngoặc",
  ...
  },
  {
    id: "equation",
    group: "single",
    titleVi: "phương trình · đánh số",
    titleEn: "equation · numbered",
    hint: "\\begin{equation}",
    descriptionVi: "Một môi trường phương trình được đánh số cho mỗi công thức",
  ...
  },
  {
    id: "equation-star",
    group: "single",
    titleVi: "phương trình* · không đánh số",
    titleEn: "equation* · unnumbered",
    hint: "\\begin{equation*}",
    descriptionVi: "Một môi trường phương trình không đánh số* cho mỗi công thức",
  ...
  },
  {
    id: "align",
    group: "multi",
    titleVi: "căn chỉnh · đánh số hàng",
    titleEn: "align · numbered rows",
    hint: "\\begin{align}",
    descriptionVi: "Kết hợp tất cả các công thức vào một môi trường căn chỉnh được đánh số",
  ...
  },
  {
    id: "align-star",
    group: "multi",
    titleVi: "căn chỉnh* · hàng không được đánh số",
    titleEn: "align* · unnumbered rows",
    hint: "\\begin{align*}",
    descriptionVi: "Kết hợp tất cả các công thức vào một môi trường căn chỉnh không đánh số*",
  ...
  },
  {
    id: "aligned",
    group: "multi",
    titleVi: "căn chỉnh · hiển thị dấu ngoặc",
    titleEn: "aligned · bracket display",
    hint: "\\[ \\begin{aligned}",
    descriptionVi: "Kết hợp tất cả các công thức trong một môi trường căn chỉnh bên trong \\[...\\]",
  ...
  },
  {
    id: "gather",
    group: "multi",
    titleVi: "tập hợp · đánh số hàng",
    titleEn: "gather · numbered rows",
    hint: "\\begin{gather}",
    descriptionVi: "Căn giữa tất cả các công thức và đánh số mỗi hàng",
  ...
  },
  {
    id: "gather-star",
    group: "multi",
    titleVi: "tập hợp* · hàng không được đánh số",
    titleEn: "gather* · unnumbered rows",
    hint: "\\begin{gather*}",
    descriptionVi: "Căn giữa tất cả các công thức không có số hàng",
  ...
  },
  {
    id: "multline",
    group: "multi",
    titleVi: "nhiều dòng · được đánh số",
    titleEn: "multline · numbered",
    hint: "\\begin{multline}",
    descriptionVi: "Coi các hàng là một phương trình dài có một số",
  ...
  },
  {
    id: "multline-star",
    group: "multi",
    titleVi: "nhiều dòng* · không đánh số",
    titleEn: "multline* · unnumbered",
    hint: "\\begin{multline*}",
    descriptionVi: "Coi các hàng là một phương trình dài không có số",
  ...
  },
  {
    id: "equation-split",
    group: "multi",
    titleVi: "phương trình + phép chia · một số",
    titleEn: "equation + split · one number",
    hint: "\\begin{equation} \\begin{split}",
    descriptionVi: "Chia tất cả các công thức bằng một số phương trình bên ngoài",
  ...
  },
  {
    ...
    group: "multi",
    titleVi: "phương trình* + chia · không đánh số",
    titleEn: "equation* + split · unnumbered",
    hint: "\\begin{equation*} \\begin{split}",
    descriptionVi: "Đặt tất cả các công thức được chia vào trong một phương trình không đánh số*",
