...
def test_counts_default_omml_delimiters_as_tokens():
    mathml = _mathml("<mrow><mo>(</mo><mi>x</mi><mo>)</mo></mrow>")
    omml = _omml("<m:d><m:dPr><m:sepChr m:val=\"\"/></m:dPr><m:e><m:r><m:t>x</m:t></m:r></m:e></m:d>")
...
def test_counts_explicit_one_sided_omml_delimiter_as_token():
    mathml = _mathml("<mrow><mo>{</mo><mi>x</mi></mrow>")
    omml = _omml("<m:d><m:dPr><m:begChr m:val=\"{\"/><m:endChr m:val=\"\"/></m:dPr><m:e><m:r><m:t>x</m:t></m:r></m:e></m:d>")
...
def test_counts_explicit_bar_omml_delimiters_as_tokens():
    mathml = _mathml("<mrow><mo>|</mo><mi>x</mi><mo>|</mo></mrow>")
    omml = _omml("<m:d><m:dPr><m:begChr m:val=\"|\"/><m:endChr m:val=\"|\"/></m:dPr><m:e><m:r><m:t>x</m:t></m:r></m:e></m:d>")
